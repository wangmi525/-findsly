...
const plans = [
  {
    name: "Starter", price: 49, yearly: 39, search: "600/mo", channels: 5, ai: "50 AI msgs", seq: "3 sequences",
    features: ["5 search sources", "5 outreach channels", "Basic CRM", "Email & WhatsApp", "3 automation sequences", "50 AI-generated messages"],
    color: "border-gray-200", btn: "bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-900"
  },
  {
    name: "Pro", price: 99, yearly: 79, search: "2,000/mo", channels: 8, ai: "200 AI msgs", seq: "10 sequences", popular: true,
    features: ["8 search sources incl. LinkedIn", "8 outreach channels", "Full CRM + Pipeline", "AI Scoring & Insights", "10 automation sequences", "Revenue tracking", "200 AI-generated messages"],
    color: "border-blue-500 ring-2 ring-blue-500", btn: "bg-blue-600 hover:bg-blue-500 text-white"
  },
  {
    name: "Growth", price: 199, yearly: 159, search: "5,000/mo", channels: 10, ai: "Unlimited AI", seq: "20 sequences",
    features: ["All 8 search sources", "All 10 channels", "Team (5 seats)", "Full pipeline & CRM", "20 sequences", "Unlimited AI messages", "Advanced analytics"],
    color: "border-purple-200", btn: "bg-purple-600 hover:bg-purple-500 text-white"
  },
  {
    name: "Scale", price: 399, yearly: 319, search: "15,000/mo", channels: 10, ai: "Unlimited AI", seq: "Unlimited",
    features: ["All features", "Team (15 seats)", "API access", "Shopify integration", "AI revenue prediction", "Role-based permissions", "Priority support"],
    color: "border-amber-200", btn: "bg-amber-600 hover:bg-amber-500 text-white"
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-white py-24">
        <div className="mx-auto max-w-7xl px-6 text-center">
          <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-medium text-blue-700">
            <Zap className="h-4 w-4" /> AI-Powered Customer Discovery
          </div>
          <h1 className="mx-auto max-w-4xl text-5xl font-extrabold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
            Find & Reach Your<br />Perfect Customers
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
            Describe your ideal customer. Our AI finds their email, WhatsApp, Instagram, and more across 8 sources. 
            Reach them all from one platform with 10 channels.
          </p>
      ...
      <section id="features" className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              { icon: Search, title: "AI Discovery", desc: "Find contacts across Google Maps, LinkedIn, Instagram, YouTube, Twitter, Reddit, TikTok, and Facebook. 8 sources, one click.", color: "text-blue-600 bg-blue-50" },
              { icon: Send, title: "10-Channel Outreach", desc: "Email, WhatsApp, Telegram, Instagram DM, Facebook Messenger, LINE, Twitter, Discord, Phone, SMS. Reach everyone where they are.", color: "text-green-600 bg-green-50" },
              { icon: BarChart3, title: "Smart CRM + Pipeline", desc: "Visual sales pipeline, AI-powered contact scoring, revenue prediction, automated follow-up sequences. Close deals faster.", color: "text-purple-600 bg-purple-50" },
            ].map((f, i) => (
